...
public class ContactLoaderFragment extends Fragment implements FragmentKeyListener {
    ...
    private static CopyContactToCardTask mCopyContactToCardTask;
    ...
    public static class CopyContactDialogFragment extends DialogFragment
        ...
        private static final String TASK_IS_RUNNING = "taskIsRunning";
        private Contact mContactData;
        private int mSubId;
        ...
        public void onSaveInstanceState(Bundle outState) {
            super.onSaveInstanceState(outState);
            outState.putBoolean(TASK_IS_RUNNING,
                    mCopyContactToCardTask.getStatus() == AsyncTask.Status.RUNNING);
        }
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            if (savedInstanceState != null) {
                wasRunning = savedInstanceState.getBoolean(TASK_IS_RUNNING);
            }
            if (mCopyContactToCardTask == null && !wasRunning) {
                if (mContactData != null) {
        ...
        public void onDestroyView() {
            super.onDestroyView();
            mCopyContactToCardTask.setCopyContactPostExecuteListener(null);
        }
